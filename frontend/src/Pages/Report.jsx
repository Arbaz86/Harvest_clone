...
export const Report = () => {
  ...
  function getprojects(res) {
    ...
    for (let i = 0; i < res.length; i++) {
      ...
      obj[res[i].project_name].billable =
        obj[res[i].project_name].billable + Billable;
      obj[res[i].project_name].notbillable =
        obj[res[i].project_name].notbillable + Notbillable;
      obj[res[i].project_name].hours =
        obj[res[i].project_name].notbillable +
        obj[res[i].project_name].billable;
  ...
  function getclient(res) {
    ...
    for (let i = 0; i < res.length; i++) {
      ...
      obj[res[i].client_name].billable =
        obj[res[i].client_name].billable + Billable;
      obj[res[i].client_name].notbillable =
        obj[res[i].client_name].notbillable + Notbillable;
      obj[res[i].client_name].hours =
        obj[res[i].client_name].notbillable + obj[res[i].client_name].billable;
  ...
  function gettask(res) {
    ...
    for (let i = 0; i < res.length; i++) {
      ...
      for (let j = 0; j < res[i].work.length; j++) {
        ...
        obj[vin.task].hours =
          obj[vin.task].billable + obj[vin.task].notbillable;
  ...
  function getteam(res) {
    ...
    for (let i = 0; i < res.length; i++) {
      ...
      obj[res[i].emp_name].notbillable =
        obj[res[i].emp_name].notbillable + Notbillable;
      obj[res[i].emp_name].hours =
        obj[res[i].emp_name].notbillable + obj[res[i].emp_name].billable;
      ...
      <Box m="auto" width={["90%", "90%", "80%"]}>
        ...
        <Box mt="3.5rem">
          <Flex alignItems="center">
            ...
            <Flex alignItems="center">
              {" "}
              <Icon as={BsArrowLeftSquare} w={8} h={8} />
              <Icon as={BsArrowRightSquare} w={8} h={8} />
            </Flex>{" "}
            <Text ml="3" fontSize="3xl" fontWeight="bolder">
              This Week: 26 Sep – 02 Oct 2022
            </Text>
            <Spacer /> <Daytypes w="140px" />{" "}
          </Flex>
