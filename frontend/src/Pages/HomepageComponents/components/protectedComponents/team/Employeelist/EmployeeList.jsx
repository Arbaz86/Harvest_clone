...
const EmployeeList = () => {
  ...
  useEffect(() => {
    axios.get("https://harvest-api.onrender.com/userData").then((r) => {
      console.log(r.data);
      setData(r.data);
    });

    axios.get("https://harvest-api.onrender.com/registeredUsers").then((r) => {
      console.log(r.data);
      setUser(r.data);
    });
  }, []);
  return (
    <Box>
      <Flex gap="10rem" marginTop="0.5rem" marginLeft="10px">
        ...
        <Flex>
          <Text className={styles.info}>{data.hours}.00</Text>
        </Flex>
