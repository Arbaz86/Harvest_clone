  ...
  const LearnObj = [
    {
      ...
      desc: "Learn how to introduce your team to time tracking and make the most of Harvest.",
    },
    {
      img: "https://www.getharvest.com/hubfs/raw_assets/public/harvest-theme/images/homepage/illo-75-laptop.svg",
      heading: "Webinars",
      desc: "Watch a quick intro to Harvest or sign up for a live session with one of our Experts.",
    },
    {
      img: "https://www.getharvest.com/hubfs/raw_assets/public/harvest-theme/images/homepage/illo-75-help.svg",
      heading: "Help Center",
      desc: "Find the answers to all your questions or get in touch with one of our friendly Experts.",
    },
  ];
  return (
    <Box className={styles.bgimg}>
      ...
      <Flex className={styles.outerflex}>
        <Box className={styles.headingdiv}>
          ...
          <Text className={styles.learning_heading} lineHeight="48px">
            ...
            <Box className={styles.learningdiv}>
              <Flex className={styles.learning_box}>
                ...
                <Flex direction="column">
                  <Text className={styles.learning_box_heading}>
                    {el.heading}
                  </Text>
