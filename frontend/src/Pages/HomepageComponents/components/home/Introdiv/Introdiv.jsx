    ...
    <Flex width="100%" className={styles.outerbox}>
      <Box className={styles.box}>
        <Flex width="60%" gap="5px">
          <Image src="https://www.getharvest.com/hubfs/raw_assets/public/harvest-theme/images/landing-pages/star-rating.svg" />
          <Text>4.6</Text>
          <Text color="#9f9f9f" fontSize="16px" fontFamily="MuotoTrial reg-400">
            (748 reviews)
          </Text>
        </Flex>
        <Text className={styles.finally_heading}>
          Time tracking your team wants to use
        </Text>
        <Text className={styles.finally_desc}>
